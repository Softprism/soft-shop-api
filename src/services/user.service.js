...
const updateUser = async (updateParam, id) => {
  const {
    first_name, last_name, address, place_id, original_password, password, email, phone_number, pushNotifications, smsNotifications, promotionalNotifications
  } = updateParam;
  // Build User Object
  const userFields = {};
